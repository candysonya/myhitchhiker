...
import { Icon, Badge, Dropdown, Menu, Modal, Upload, TreeSelect, message } from 'antd';
...
class HeaderPanel extends React.Component<HeaderPanelProps, HeaderPanelState> {
    ...
    public componentDidUpdate(prevProps: HeaderPanelProps, prevState: HeaderPanelState) {
        ...
        if (!!messagetext && messagetext === 'ok') {
	        message.success(LocalesString.get("Common.SuccessMsg"));
        }else if(!!messagetext) {
