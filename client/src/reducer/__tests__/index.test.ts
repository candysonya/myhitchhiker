...
const defaultRecordState = { name: '', isRequesting: false, isChanged: false, record: {}, parameter: allParameter, conflictType: ConflictType.none, apiId: '-1' };
const c1 = { id: 'cid_123', name: 'c1', commonPreScript: '', commonSetting, projectId: 'pid_123', description: '', apiId: '-1' };
const c2 = { id: 'cid_456', name: 'c2', commonPreScript: '', commonSetting, projectId: 'pid_123', description: '', apiId: '-1' };
const c3 = { id: 'cid_789', name: 'c3', commonPreScript: '', commonSetting, projectId: 'pid_789', description: '', apiId: '-1' };
const r1 = { id: 'rid_123', collectionId: 'cid_123', category: RecordCategory.record, parameterType: ParameterType.ManyToMany, name: 'r1', headers: [], apiId: '-1' };
const r2 = { id: 'rid_456', collectionId: 'cid_456', category: RecordCategory.record, parameterType: ParameterType.ManyToMany, name: 'r2', apiId: '-1' };
const r3 = { id: 'rid_789', collectionId: 'cid_789', category: RecordCategory.record, parameterType: ParameterType.ManyToMany, name: 'r3', apiId: '-1' };
